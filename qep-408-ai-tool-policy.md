# QGIS Enhancement: AI tool use policy
...
LLM/AI are nowadays a reality, that whether we like it or not, introduces new
...
::
    ...
    https://github.com/qgis/QGIS-Enhancement-Proposals/blob/master/qep-407-ai-tool-policy.md
