...
Export a model to a python implementation is broken as soon as there is a branch in the model (see ticket https://github.com/qgis/QGIS/issues/49053). Because the export to python flatten all algorithms and not necessarily in the right order
